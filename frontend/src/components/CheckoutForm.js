...
function CheckoutForm() {
    ...
    async function handlePay(e) {
        ...
        if (paymentIntent) {
            createOrder({ userId: user._id, cart: user.cart, address, country, postcode, phone }).then((res) => {
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Username" value={user.name} disabled />
                        </Form.Group>
                    </Col>
                    <Col md={6}>
                        <Form.Group className="mb-3">
                ...
                <Row>
                    ...
                    <Col md={3}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" placeholder="Postcode" value={postcode} onChange={(e) => setPostcode(e.target.value)} required />
                        </Form.Group>
                    </Col>
                    <Col md={3}>
                        <Form.Group className="mb-3">
